...
class ChatHistory:
    ...
    def default_prompt(self, topic):
        return f"Hello! Ask me about clubs at Santa Clara University! I can recommend clubs based on your background and interests or give you more information about clubs you already know!"
